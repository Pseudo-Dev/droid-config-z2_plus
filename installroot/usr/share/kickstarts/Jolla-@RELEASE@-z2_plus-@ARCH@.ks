# DisplayName: Jolla z2_plus/@ARCH@ (release) 1
...
repo --name=adaptation-community-common-z2_plus-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration z2_plus
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/z2_plus
